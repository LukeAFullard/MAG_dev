    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <header className="bg-slate-900 text-slate-50 shadow-md flex flex-col border-b border-slate-800">
        <div className="p-4 flex flex-col md:flex-row justify-between items-center">
            ...
            <h1 className="text-2xl font-bold tracking-tight">MAG_dev: Gymnastics Analysis</h1>
            </div>
        ...
        <nav className="flex px-4 overflow-x-auto border-t border-slate-800 bg-slate-900/50">
            <NavLink to="/overview" className={({isActive}) => `px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-200'}`}>
                Overview
            </NavLink>
            <NavLink to="/athletes" className={({isActive}) => `px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-200'}`}>
                Athletes
            </NavLink>
            <NavLink to="/capture" className={({isActive}) => `px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-200'}`}>
                Capture & Process
            </NavLink>
            <NavLink to="/dashboard" className={({isActive}) => `px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-200'}`}>
                Dashboard
            </NavLink>
            <NavLink to="/analysis" className={({isActive}) => `px-4 py-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${isActive ? 'border-blue-500 text-blue-400' : 'border-transparent text-slate-400 hover:text-slate-200'}`}>
                Analysis Tools {selectedAttemptForAnnotation && <span className="ml-1 inline-flex w-2 h-2 rounded-full bg-blue-500"></span>}
            </NavLink>
        </nav>
      </header>
                ...
                <Route path="/overview" element={
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-8">
                        <div className="mb-8">
                            ...
                            We use a robust 3-pass processing pipeline and secure local storage. Use the navigation tabs above to manage your workflow.
                            </p>
                        </div>
                ...
                <Route path="/capture" element={
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 md:p-8">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 mt-1">Upload or record an attempt for automated extraction and pose evaluation.</p>
                        </div>
                        <CaptureGuidelines />
                        </div>
                ...
                <Route path="/analysis" element={
                    <div className="space-y-8">
                        ...
                        <div className="bg-white border p-12 rounded-xl text-center text-slate-500 shadow-sm">
                            ...
                            <p className="text-lg font-medium text-slate-700">No Attempt Selected</p>
                            <p className="mt-2 text-sm">Please select an attempt from the <NavLink to="/dashboard" className="text-blue-500 hover:underline">Session Dashboard</NavLink> to view or edit manual annotations.</p>
                        </div>
                        )}
